...
export default function AssetPicker({ open, onClose, onSelect, projectId, selectedAssetId }: AssetPickerProps) {
	const rpc = useRPC();
	...
	return (
		<SubDialog open={open} onClose={onClose} title="Select Cover Image">
			<div className={styles.content}>
				<p className={styles.aspectHint}>Recommended: 2:3 aspect ratio for book covers</p>
				...
				{loading ? (
					...
					<div className={styles.empty}>No covers yet. Upload an image above.</div>
				) : (
